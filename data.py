...
class New_Items(Items):
    ...
    def make_reviews_links(self,links):
        reviews_links = []
        for link in links:
            item_id = link.split("%3FitemID%3D")[1].split("%26")[0]
...
def runner():
    spreadsheet_url = 'https://docs.google.com/spreadsheets/d/1j4of5mznL24dWs17rPrHuVWwSjzt76m1YkgIaPenOmQ/edit'
    database.remove_bad_files()
    """new_items.upload_data(spreadsheet_url,20,50)
